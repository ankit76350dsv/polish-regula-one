...
//   2. An old flat bookmark:    "/employees/12"  -> "/company/{tenantId}/employees/12"
//
// WHY CASE 2 EXISTS (BACKWARD COMPATIBILITY)
// Before this change every page lived at a flat address like "/employees". People
...
export default function TenantRedirect() {
  ...
  // Keep the query string so a shared link still opens the same view the sender
  // was looking at.
