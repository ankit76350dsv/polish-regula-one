...
//   - if the account has been switched off -> show the "account suspended" page
...
//   - if they were never given WasteSync -> show the "no permission" page
...
export default function ModuleAccessGuard() {
  ...
  // The company DOES have WasteSync, but this particular user was not given
  // permission to use it. Every WasteSync API would answer 403 for them, so we show
  // one clear message instead of letting every page fail on its own.
