...
//
// This is the same control SafeWork uses, on purpose: someone moving between the
// RegulaOne apps should find the language switch in the same place, looking and
