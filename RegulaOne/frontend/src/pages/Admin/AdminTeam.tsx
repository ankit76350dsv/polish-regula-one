...
const MOCK_TENANT_USERS: TenantUser[] = [
...
export default function AdminTeam() {
  ...
  const [inviteRole, setInviteRole] = useState<'ROLE_ADMIN' | 'ROLE_USER'>('ROLE_USER');
  ...
  const toggleStatus = (id: string, current: string) => {
    ...
    setUsers(prev => prev.map(u => u.id === id ? { ...u, status: next as TenantUser['status'] } : u));
