        ...
        {!collapsed && (
          <div className="flex flex-col">
            <div className="flex items-center gap-2 text-cyan-600">
              ...
              <span className="font-bold text-sm tracking-widest text-slate-900 uppercase">{t("app.name")}</span>
            </div>
        ...
        {!collapsed ? (
          <div className="bg-slate-50 p-2.5 rounded-lg border border-slate-200 flex flex-col gap-1">
            <div className="flex items-center gap-1.5 text-[10px] font-mono font-semibold text-slate-700 leading-none">
              <Lock className="w-3 h-3 text-emerald-600" /> {t("nav.noTelemetryTitle")}
            </div>
            <p className="text-[9px] text-slate-500 mt-0.5 leading-relaxed">{t("nav.noTelemetryBody")}</p>
          </div>
        ) : (
    ...
    <header className="bg-white border-b border-slate-200 px-6 py-3 flex items-center justify-between">
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-semibold text-slate-700">{t("navbar.intakeActive")}</span>
        </div>
      ...
      <div className="flex items-center gap-4 relative">
        ...
        <div className="flex items-center gap-2">
          <label htmlFor="role-simulator" className="text-xs text-slate-500 font-medium hidden sm:inline">
