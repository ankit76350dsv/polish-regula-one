...
import { JURISDICTIONS, POLAND } from "./jurisdictions";
...
const configuredCode =
  import.meta.env.VITE_SAFEVOICE_JURISDICTION?.toUpperCase();
...
export const activeJurisdiction =
...
export const useJurisdiction = () => activeJurisdiction;
