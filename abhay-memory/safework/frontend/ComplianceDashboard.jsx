...
const statusConfig = {
  ...
  // Neutral grey badge for a document the role does not need — NOT a red "Missing".
  not_required: { label: "Not required", cls: "bg-slate-100 text-slate-500 ring-1 ring-slate-200", dot: "bg-slate-400" },
};
