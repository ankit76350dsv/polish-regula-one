...
// Converts known error types to user-friendly responses and never leaks a
// stack trace to the client (a platform security rule).
const errorHandler = (err, req, res, next) => {
  ...
  // Some services throw plain objects shaped as { status, message }.
  if (err.status) {
