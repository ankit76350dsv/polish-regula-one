// Which websites are allowed to call the WorkPulse API from a browser.
//
...
// very same machine.
//
// We cannot fix that by allowing everything: WorkPulse sends the sign-in cookie with each
