...
// This mirrors WasteSync and SafeWork so every module behaves the same way.
...
const resolveServiceUrl = (configuredUrl, port, defaultPath = "") => {
  // Nothing configured: use this browser's host with the service's port.
...
// The WorkPulse backend — clock-ins, absences, policy, reports. Port 8085.
