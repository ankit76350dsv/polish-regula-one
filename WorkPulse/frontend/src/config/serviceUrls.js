// Resolve local services from the hostname used in the browser. This keeps API
// calls, SSO redirects, cookies and CORS on one host for both localhost and LAN
// tester access. Explicit non-local URLs remain available for deployed builds.
...
export const WORKPULSE_API_URL = resolveServiceUrl(
  import.meta.env.VITE_WORKPULSE_API_URL,
  8085
);
export const APP_URL = resolveServiceUrl(import.meta.env.VITE_APP_URL, 3005);
