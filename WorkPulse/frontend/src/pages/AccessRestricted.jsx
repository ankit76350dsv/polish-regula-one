...
//
// This mirrors safeWork/frontend/src/pages/AccessRestricted.jsx. The wording is
// kept the same word-for-word (with "WorkPulse" in place of "SafeWork") so a user
// who moves between the two apps sees one consistent platform. SafeWork reads its
// text from translation files; WorkPulse has no translation setup yet, so the
// sentences are written here directly.
const VARIANTS = {
  ...
  [ACCESS.MODULE_UNAVAILABLE]: {
    ...
    title: "WorkPulse is not part of your plan",
    message:
  ...
  [ACCESS.PERMISSION_DENIED]: {
    ...
    title: "You do not have access to WorkPulse",
    message:
